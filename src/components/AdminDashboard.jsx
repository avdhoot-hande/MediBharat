  ...
  return (
    <div className="admin-container">
      <div className="sidebar">
        ...
        <ul>
          <li onClick={() => setActiveTab("addDoctor")} className={activeTab === "addDoctor" ? "active" : ""}>Add Hospital</li>
          <li onClick={() => setActiveTab("deleteDoctor")} className={activeTab === "deleteDoctor" ? "active" : ""}>Delete Hospital</li>
